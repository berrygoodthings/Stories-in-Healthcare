...
const ResourcesPage = ({}) =>{
    ...
    return(
        <Layout>
            ...
            <Row>
                <img src={Banner} alt="people" />
            </Row>
            <Row>            
            <h1>About Istorio</h1>

            <p>Istorio is a pilot platform with the intention of encouraging self-advocacy for migrants to the UK through the exchange of stories and experiences. Migrants are people who have emigrated or expatriated for varying reasons, including circumstances that can lead them to being undocumented. Both undocumented and documented migrants are faced with various factors that can impair their ability to obtain healthcare or navigate through an unfamiliar system and cultural attitudes towards health.</p>
